...
constexpr std::string_view DEFAULT_PATH = "\\VolumetricShaderHelper\\timecycle\\default\\";
constexpr std::string_view OVERRIDE_PATH = "\\VolumetricShaderHelper\\timecycle\\override\\";
