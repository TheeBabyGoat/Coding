...
#define PTFX_EFFECTINST_VEHICLE_WHEEL_ATTACHED_TRAILING		(PTXEFFECTFLAG_USER11)
	...
	struct ptxParticleRule : public pgBaseRefCounted
	{
		...
		atArray<datRef<ptxBehaviour>> m_allBehaviours;	
		...
		ptxSortType m_sortType;
		ptxDrawType m_drawType;
