...
std::optional<std::vector<std::string>> CloudSettingsXmlParser::GetSettingsNames(const std::string& xml_text)
{
	...
	{
		names.push_back(ItemNode.child("Name").text().as_string());
	}
