...
public: 
	...
	auto& GetXmlParser()				{ return m_XmlParser; }
	auto& GetCloudSettingsVec()			{ return NamedCloudsSettingsVec; }
	auto& GetCloudHatNamesArray()		{ return gCloudHatNames; }
