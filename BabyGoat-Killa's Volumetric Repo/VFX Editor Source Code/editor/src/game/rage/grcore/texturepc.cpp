...
bool rage::grcTexturePC::LockRect(int layer, int mipLevel, grcTextureLock& lock, int lockFlags)
{
...
atFixedBitSet<8, u8> rage::grcTexturePC::FindUsedChannels() const
{
...
rage::grcTextureFactory* rage::grcTextureFactory::GetInstance()
{
	static grcTextureFactory* obj = *gmAddress::Scan("84 DB 48 0F 45 C2 48 89 05").GetRef(9).To<grcTextureFactory**>();
	return obj;
}

rage::grcTexture* rage::grcTextureFactory::CreateFromDDSImage(std::filesystem::path path, grcImage::Format img_format)
{
...
rage::grcTexture* rage::grcTextureFactory::CreateFromPath(std::filesystem::path path, grcImage::Format img_format)
{
	...
	static constexpr std::array extensions = { ".jpg", ".png", ".tga", ".bmp", ".psd", ".gif", ".hdr", ".pic" };
	grcTexture* texture = nullptr;
