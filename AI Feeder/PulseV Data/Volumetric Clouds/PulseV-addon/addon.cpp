...
static constexpr int TIME_SEGMENT_COUNT = 13;
...
static const char *const timeSegmentLabels[TIME_SEGMENT_COUNT] = {
    "00:00", "05:00", "06:00", "07:00", "09:00", "12:00", "16:00",
...
// Metadata for addon
extern "C" __declspec(dllexport) const char *NAME = "PulseV-Helper";
extern "C" __declspec(dllexport) const char *DESCRIPTION = "Provides game data as shader uniforms";
