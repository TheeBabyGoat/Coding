...
uniform float PRESET##BottomScale < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomDetailScale < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Detail Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomStretch < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Stretch"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomBaseCurl < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Base Curl"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomDetailCurl < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Detail Curl"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomBaseCurlScale < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Base Curl Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomDetailCurlScale < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Detail Curl Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomSmoothness < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Smoothness"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomSoftness < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Softness"; \
    string ui_type = "drag"; \
    float ui_min = -1.00; \
    float ui_max = 1.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomBottom < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Bottom Height"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
...
uniform float PRESET##BottomTop < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Top Height"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 10000.00; \
    float ui_step = 1.0; \
...
uniform float PRESET##BottomCover < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Coverage"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomExtinction < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Extinction"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomAmbientAmount < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Ambient Amount"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomAbsorption < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Absorption"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomLuminance < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Luminance"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomSunLightPower < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Sun Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomSkyLightPower < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Sky Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomMoonLightPower < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Moon Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomBottomDensity < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Bottom Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomMiddleDensity < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Middle Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##BottomTopDensity < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Bottom Layer Top Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopScale < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopDetailScale < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Detail Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopStretch < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Stretch"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopBaseCurl < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Base Curl"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopDetailCurl < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Detail Curl"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopBaseCurlScale < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Base Curl Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopDetailCurlScale < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Detail Curl Scale"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopSmoothness < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Smoothness"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopSoftness < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Top Layer Softness"; \
    string ui_type = "drag"; \
    float ui_min = -1.00; \
    float ui_max = 1.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopBottom < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Bottom Height"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 10000.00; \
    float ui_step = 1.0; \
...
uniform float PRESET##TopTop < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Top Height"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 10000.00; \
    float ui_step = 1.0; \
...
uniform float PRESET##TopCover < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Coverage"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopExtinction < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Extinction"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopAmbientAmount < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Ambient Amount"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopAbsorption < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Absorption"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopLuminance < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Luminance"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopSunLightPower < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Sun Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopSkyLightPower < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Sky Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopMoonLightPower < \
    string ui_category = #PRESET " Weather"; \
    string ui_label = "Top Layer Moon Light Power"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopBottomDensity < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Bottom Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopMiddleDensity < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Middle Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
...
uniform float PRESET##TopTopDensity < \
    string ui_category = #PRESET " Weather"; \
	string ui_label = "Top Layer Top Density"; \
    string ui_type = "drag"; \
    float ui_min = 0.00; \
    float ui_max = 2.00; \
    float ui_step = 0.01; \
