...
uniform float2 inputWindPosition < string source = "wind_position"; >;
uniform float inputWindSpeed < string source = "wind_speed"; >;
...
uniform float timer < string source = "game_timer"; >;

// ============================================================================ 
//                      UI UNIFORMS (Preset Settings)
// ============================================================================
uniform bool cloudQualityInfo <
    string ui_category = "Preset Settings";
    bool ui_category_closed = true;
    string ui_type = "label";
    string ui_label = "Info: Preset Profiles with manual Override.";
> = false;
uniform int qualityPreset <
    string ui_category = "Preset Settings";
    string ui_label = "Cloud Quality Preset";
    string ui_type = "combo";
    string ui_items = "Custom\0Low\0Medium\0High\0Ultra\0Extreme\0";
> = 0;
...
uniform int cloudVolumeSamples <
    string ui_category = "Preset Settings";
    string ui_label = "Cloud Manual Volume";
    string ui_type = "slider";
    int ui_min = 10;
    int ui_max = 200;
    bool hidden = (qualityPreset != 0);
> = 64;

uniform int auroraVolumeSamples <
    string ui_category = "Preset Settings";
    string ui_label = "Aurora Manual Volume";
    string ui_type = "slider";
    int ui_min = 8;
    int ui_max = 128;
    bool hidden = (auroraQualityPreset != 0);
> = 64;
// ============================================================================ 
//                      UI UNIFORMS (Global Settings)
// ============================================================================
uniform bool globalShaderInfo <
    string ui_category = "Global Settings";
    bool ui_category_closed = true;
    string ui_type = "label";
    string ui_label = "Info: Global Cloud Controls.";
> = false;
...
uniform float cloudWindSpeed <
    string ui_category = "Global Settings";
    string ui_label = "Cloud Wind Speed";
    string ui_type = "drag";
    float ui_min = 0.00;
    float ui_max = 10.0;
    float ui_step = 0.01;
...
uniform bool cloudShapeInfo <
    string ui_category = "Cloud Shape";
    bool ui_category_closed = true;
    string ui_type = "label";
    string ui_label = "Info: These are Advanced parameters to control the cloud size, detail, and vertical shape.";
> = false;
uniform float cloudScale <
    string ui_category = "Cloud Shape";
    string ui_type = "Scale";
    string ui_type = "drag";
    float ui_min = 0.01;
    float ui_max = 8.0;
    float ui_step = 0.01;
...
uniform float cloudSunLightPower <
    string ui_category = "Advanced Global Settings";
    string ui_label = "Sun Light Amount";
    string ui_type = "drag";
    float ui_min = 0.01;
    float ui_max = 8.0;
    float ui_step = 0.01;
...
uniform float cloudMoonLightPower <
    string ui_category = "Advanced Global Settings";
    string ui_label = "Moon Light Amount";
    string ui_type = "drag";
    float ui_min = 0.01;
    float ui_max = 8.0;
    float ui_step = 0.01;
...
uniform bool auroraShaderInfo <
    string ui_category = "Aurora Settings";
    bool ui_category_closed = true;
    string ui_type = "label";
    string ui_label = "Info: Aurora Volumetric Settings and Controls.";
> = false;
...
uniform float auroraTimeScale <
    string ui_category = "Aurora Settings";
    string ui_label = "Aurora Time Scale";
    string ui_type = "drag";
    float ui_min = 0.0;
    float ui_max = 20.0;
    float ui_step = 0.1;
...
uniform float auroraBrightness <
    string ui_category = "Aurora Settings";
    string ui_label = "Aurora Brightness";
    string ui_type = "drag";
    float ui_min = 0.0;
    float ui_max = 100.0;
    float ui_step = 0.01;
...
uniform float auroraDensityMultiplier <
    string ui_category = "Aurora Settings";
    string ui_label = "Aurora Density";
    string ui_type = "drag";
    float ui_min = 0.0;
    float ui_max = 100.0;
    float ui_step = 0.01;
...
uniform bool depthShaderInfo <
    string ui_category = "Post-Processing";
    bool ui_category_closed = true;
    string ui_type = "label";
    string ui_label = "Info: Depth Edge and Threshold controls.";
> = false;
uniform float cloudDepthEdgeFar <
    string ui_category = "Post-Processing";
    string ui_label = "Depth Edge";
    string ui_type = "drag";
    float ui_min = 1.0;
    float ui_max = 10000.0;
    float ui_step = 1.0;
