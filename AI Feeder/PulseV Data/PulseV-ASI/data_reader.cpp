/*
 * Description: Logic for reading game data, refactored for ASI (ScriptHookV)
 */
...
static void update() {
    ...
    TimeCycle::RegionalWeather from_weather = { _from_weather_type, _region };
    TimeCycle::RegionalWeather to_weather = { _to_weather_type, _region };
